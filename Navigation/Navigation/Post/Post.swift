...
public struct Post {
    ...
    public static let test2 = Post(title: "Коты", author: "naumroitman",
                            description: "Взгляд говорит обо всём",
                            image: "Cat_2", likes: 35, views: 489)
    public static let test3 = Post(title: "Ведьмак", author: "tasha_kniginya",
                            description: "С возвращением",
                            image: "Vedmak", likes: 265, views: 156)
    public static let test4 = Post(title: "Порто Флавия, Иглезиас, Италия.", author: "m.y_p.l.a.n.e.t",
    ...
    public static let testPosts = [test1, test2, test3, test4]
}
